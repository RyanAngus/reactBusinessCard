...
export default function Footer() {
    return (
        ...
        <a href="www.linkedin.com/in/ryan-angus-phd-0abab714" target="_blank"><FontAwesomeIcon className='text-3xl text-white hover:text-blue-200 cursor-pointer' icon={ faLinkedin }></FontAwesomeIcon></a>
